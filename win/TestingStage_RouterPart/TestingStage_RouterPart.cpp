...
int main(int argc, char* argv[]) {
	...
	string modelFileName = "model-sr_50.xml";		// model file name, .bin, .xml or .json 
	string urlFileName = "URL_test_list.csv";		// Testing URL list. fields: id,url,label
	string resultFileName = "results-sr_50.csv";  // Testing output results csv file name. 
												// Fields -> URL,label,predictedlabel,totalTime,getTime,cleanTime,tfidfCalcTime,classifyTime,predictedlabel,0,1,2,3,4,5,6,tokensAmount
	string dfFileName = "df_50.csv";			// DF file from training stage. 
											
	string tokensFileName = "tokens_50.txt";	// Dictionary from training stage
	string model = "sr";						// model name: sr, svm, tree, rf
